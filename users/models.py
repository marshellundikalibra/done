...
# 20:30
    ...
    def send_activation_code(self ):
        ...
        self.set_activation_code()
        activation_link=f"http://127.0.0.1:8000/v1/api/user/activate/{self.activation_code}"
        message=f"Активируйте свой аккаунт, перейдя по ссылке\n{activation_link} "
        send_mail("Activate account", message,'wordreplaceword171005@gmail.com' ,recipient_list=[self.email])
    ...
    #     Потвердите ваш заказ: {activation_url}
    #     """
    #     send_mail=("Ваш заказ готов ", message, "apple_store@gmail.com", [self.email, ])